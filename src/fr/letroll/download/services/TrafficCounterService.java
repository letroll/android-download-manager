...
public class TrafficCounterService extends Service {
	...
	public void onCreate() {
		...
		try {
			info = packageManager.getApplicationInfo(this.getPackageName(), PackageManager.GET_META_DATA);
			mUid = info.uid;
		...
		if (timer != null && timerTask != null) {
			...
			if (!ConfigUtils.getString(this, ConfigUtils.KEY_Network_Operator_Name).equals(operatorName)) {
